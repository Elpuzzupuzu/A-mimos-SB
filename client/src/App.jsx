...
//                     <Route path="recover-password" element={<RecoverPassword />} /> {/* Nueva ruta para RecoverPassword */}
//                 </Route>
        ...
        <div className="flex flex-col overflow-hidden bg-white">
            <Routes>
                ...
                <Route path="/shop" element={
                    ...
                    <Route path="checkout" element={<ShoppingCheckout />} />
                    <Route path="account" element={<ShoppingAccount />} />
                    <Route path="paypal-return" element={<PaypalReturnPage />} /> {/* Ruta para la página de retorno de PayPal */}
                    <Route path="payment-success" element={<PaypalSuccessPage />} />
                </Route>
